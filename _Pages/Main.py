...
def render_page():     
    ...
    The project offers a range of visualizations that display interesting information about the championship, such as the number of wins by each nation and the position of drivers over time
